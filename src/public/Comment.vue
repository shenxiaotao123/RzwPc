...
<template>
  ...
  <div class="all medium">
    <div class="scorenavBox">
      <div class="fr">好评率 %</div>
      <ul class="scorenav">
        <li class="fontcolor">全部 </li>
        <li>好评 </li>
        <li>中评 </li>
        <li>差评 </li>
        <li class="fr">好评率 %</li>
    ...
    <div class="allcomment">
      <div class="scoreList">
        <h6>
          <span class="fr commentGood">好评</span>
          <el-avatar :size="14" :src="circleUrl" class="v-middle"></el-avatar>
          面子
          <span class="m-l text-gray">2020-05-14 17:54</span>
        </h6>
...
<style lang="less">
  ...
  .compCon { padding: 45px;
    .scorenavBox { padding: 5px 20px; background: #f7f7f7; font-size: 14px;
      .scorenav {
        &:after { content:"."; display:block; height:0; clear:both; visibility:hidden;}
        li { padding: 0 10px; float: left;}
      }
    }
    .scoreList { padding: 20px 0; border-bottom: 1px solid #eee;
      h6 { font-weight: 300;}
      .commentGood{
        width: 40px;
        text-align: right;
        background-repeat: no-repeat;
        background-image: url("~@/assets/img/components/good.png");
  ...
  .commentbad{
    ...
    text-align: right;
    background-repeat: no-repeat;
    background-image: url("~@/assets/img/components/bad.png");
    background-size: contain;
    color: #666666;
  }
  .commentMedium{
